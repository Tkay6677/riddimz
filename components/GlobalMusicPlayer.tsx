...
import { 
  Play, Pause, SkipForward, SkipBack, Volume2, VolumeX, X, Maximize2
} from 'lucide-react'
    ...
    <Card className="fixed bottom-4 right-4 w-80 bg-background/95 backdrop-blur-sm border shadow-lg z-50">
      <CardContent className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          <h4 className="text-sm font-medium text-muted-foreground">Now Playing</h4>
          <div className="flex items-center gap-1">
            <Button
              variant="ghost"
              size="icon"
              className="h-6 w-6"
              onClick={() => {/* TODO: Expand to full player */}}
            >
